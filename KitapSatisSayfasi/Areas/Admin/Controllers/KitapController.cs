...
namespace KitapSatisSayfasi.Areas.Admin.Controllers
{
    ...
    public class KitapController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("KitapID,KitapAdi,YazarID,YayinEviID,KapakResmi,Ozet,Fiyat,BasimTarihi,TavsiyeSayisi,StokAdeti")] Kitap kitap,IFormFile dosya)
        {
            ...
            //return Content("dosya adı="+dosyaAdi);
        }

        // GET: Admin/Kitaplar/Edit/5
        ...
        // POST: Admin/Kitaplar/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("KitapID,KitapAdi,YazarID,YayinEviID,KapakResmi,Ozet,Fiyat,BasimTarihi,TavsiyeSayisi,StokAdeti")] Kitap kitap, IFormFile dosya)
        {
            if (id != kitap.KitapID)
            {
                return NotFound();
